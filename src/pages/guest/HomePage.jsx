...
function HomePage () {
    ...
    return(
        <>
            ...
            <section>
                <h1>COCOWORK</h1>
                <p>Découvrez notre espace de coworking dynamique, conçu pour répondre à tous vos besoins professionnels. Avec une variété de services et d'installations, nous sommes là pour vous accompagner dans votre réussite.
